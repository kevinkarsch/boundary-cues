...
elseif strcmp(name,'Nbinom5')
  kernel = binomialFilter(5);
elseif strcmp(name,'Zbinom5')
  kernel = binomialFilter(5)/sqrt(2);
...
elseif strcmp(name,'laplace5')
  kernel = [1, -4, 6, -4, 1]'/16;
elseif strcmp(name,'box5')
  kernel = ones(5,1)/(2.5*sqrt(2));
else
